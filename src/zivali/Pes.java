package zivali;
public class Pes extends Zival { /* Izpeljan razred */
    private double masa; /* Spremenljivke */
    private int casSprehodov;
    private int steviloObrokov;

    public Pes(){} /* Konstruktor */
    ...
    public double getMasa(){ /*  Dostopne metode */
        return masa;
    }
    ...
    public boolean aliJeMladic(){ /* Program preveri ali je pes mladic (mlajsi od dveh let) */
        return getStarost() < 2;
    }
    ...
    public void lajez(){ /* Metoda obnašanja - lajež psa. */
        System.out.println("Woof woof!"); 
    }

    public String toString () {
        return super.toString() + "\n" +
        "Priporocen dnevni vnos kalorij je: " + ((int)(priporocenDnevniVnosKalorij()) +  "," + "\n" + /* Program izpise ime in starost iz glavnega razreda ter priporocen */
        "poraba kalorij znasa: " + ((int)(porabaKalorij()) + "," +"\n" +                              /* dnevni vnos kalorij, porabo kalorij in priporoceno stevilo kalorij na obrok iz izpeljanega razreda. */
        "zato je priporoceno stevilo kalorij na obrok: " + ((int)(kalorijeNaObrok()) + "." )));
    }
}
